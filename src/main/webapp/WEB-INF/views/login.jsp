            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0" style="width: 600px;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block"><img src="../resources/img/bg.png"></div>
                            <div class="col-lg-6">
                                <div class="p-5"  style="margin-top: 100px">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4" style="font : bold">Let'sure Go</h1>
                                    </div>
                                    <form class="user">
                                        ...
                                        <a href="/adminMain.do" class="btn btn-admin-primary btn-user btn-block">
                                       	관리자 로그인
                                        </a>
                                        <hr>
                                        <!-- 
